<nav id="home-navbar" class="navbar is-fixed-top" role="navigation">	
	...
	<div id="collapsible-navbar" class="navbar-menu">
		<div class="navbar-end">
			<a class="navbar-item" href="http://www.hcny.org/english">English Ministry</a>
			...
			<a class="navbar-item" href="<?php echo get_post_type_archive_link('album'); ?>">圖片集錦</a>
			<a class="navbar-item" href="<?php echo site_url('/find-church'); ?>">教會搜索</a>
